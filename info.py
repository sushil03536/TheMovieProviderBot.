...
BOT_TOKEN = environ.get('BOT_TOKEN', "7768875639:AAHwW7qZBbJYWP9AZlL955KXgV6m71oGfrA")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5657118987 6859451629').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002335510269').split()] #Channel id for auto indexing ( make sure bot is admin )
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002436640120') # request channel id ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://devvrat4517:devvrat4517@cluster0.c8f7j.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '3900167d259e395a6ff8abf5e0b8ea64ca4632c8')
